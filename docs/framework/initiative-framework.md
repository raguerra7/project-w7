...
- Its own repository, issue tracker and release process when its work requires them.
...
3. **Register it** in `docs/initiatives/<initiative-name>/README.md` in this repository, using `templates/initiative-template.md`. WarTips is the first completed example, not the template itself.
4. **Add it to the ecosystem table** in the root `README.md` and to the [Roadmap](../roadmap/roadmap.md) if it is not yet active.
...
- `templates/initiative-template.md` — the canonical registration structure at the repository root
- [WarTips](../initiatives/wartips/README.md) — the first initiative registered with this framework
